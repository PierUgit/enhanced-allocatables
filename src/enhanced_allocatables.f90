...
! - The reallocatable/resizable features are achieved through directly manipulating
!   the C array descriptors in the framework of the C interoperability: this is non
!   standard, and therefore not guaranteed to be portable ! 
!
!                          FOR DEMONSTRATION PURPOSE ONLY
!***********************************************************************************************
